...
def main():
    ...
    parser.add_argument('--augment_type_for_short', type=str, default='none',
    ...
    # model args
    parser.add_argument("--model_name", default='MK4SRec', type=str)
